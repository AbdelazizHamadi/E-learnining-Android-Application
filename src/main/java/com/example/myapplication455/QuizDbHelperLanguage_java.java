...
public class QuizDbHelperLanguage_java extends SQLiteOpenHelper {


    private static final String DATABASE_NAME ="MyQuizJava.db";
    ...
    public QuizDbHelperLanguage_java (Context context ) {
