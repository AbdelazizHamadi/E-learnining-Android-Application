...
public class QuizDbHelperLanguage_php extends SQLiteOpenHelper {


    private static final String DATABASE_NAME ="MyQuizPhp.db";
    ...
    public QuizDbHelperLanguage_php (Context context ) {
