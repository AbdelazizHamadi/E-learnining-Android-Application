...
public class Qst_Answer2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qst__answer2);
        ...
        rbGroup = (RadioGroup) findViewById(R.id.rg1_2);
        rb1 = (RadioButton) findViewById(R.id.rb1_2);
        rb2 = (RadioButton) findViewById(R.id.rb2_2);
        rb3 = (RadioButton) findViewById(R.id.rb3_2);
        submit = (TextView)findViewById(R.id.submit_2);
        textViewQuestion= (TextView)findViewById(R.id.textViewQuestion_2);
        textViewQuestionCount=(TextView)findViewById(R.id.textViewQuestionCount_2) ;
        ScoreAffichage=(TextView)findViewById(R.id.textViewScore_2);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(Qst_Answer2.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
