...
public class Qst_Answer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qst__answer);
        ...
        rbGroup = (RadioGroup) findViewById(R.id.rg1);
        rb1 = (RadioButton) findViewById(R.id.rb1);
        rb2 = (RadioButton) findViewById(R.id.rb2);
        rb3 = (RadioButton) findViewById(R.id.rb3);
        submit = (TextView)findViewById(R.id.submit);
        textViewQuestion= (TextView)findViewById(R.id.textViewQuestion);
        textViewQuestionCount=(TextView)findViewById(R.id.textViewQuestionCount) ;
        ScoreAffichage=(TextView)findViewById(R.id.textViewScore);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(Qst_Answer.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
